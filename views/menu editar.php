...
<body class="container-fluid m-0 p-0">        
    ...
    <main class="container row">
        <form action="/menu/editar_save/<?php echo $id?>" method="post" class="col-md-6 col-sm-12 offset-md-4 mt-3">
            <div class="mb-3 row">
                ...
                <div class="col-sm-9 dropdown">
                   <select class="form-control" name="dependencia" id="dependencia">
                        ...
                        <?php foreach ($data as $key => $row): ?>
                            <option value="<?php echo $row->id ?>" <?php echo ($row->id == $menu->dependencia_id) ? "selected" : ""; ?>><?php echo $row->nombre_menu ?></option>
                        <?php endforeach; ?>
                   </select>
                </div>
            </div>
            <div class="mb-3 row">
                ...
                <div class="col-sm-9">
                <input type="text" class="form-control" id="nombre" name="nombre" value="<?php echo $menu->nombre_menu ?>" required>
                </div>
            </div>
            <div class="mb-3 row">
                ...
                <div class="col-sm-9">
                    ...
                    name="descripcion" 
                    placeholder="Describe el menu" 
                    style="height: 100px" required><?php echo $menu->descripcion_menu?></textarea>                    
                </div>
            </div>
